<?php
     ...
     *
     */
    class FormProcessor_ResourceImage extends FormProcessor
    {
        public $resource;
        public $image;
        ...
        public function __construct(DatabaseObject_Resource $resource)
        {
            ...
            $this->image = new DatabaseObject_ResourceImage($resource->getDb());
            $this->image->rsrc_id = $this->resource->getId();
        }
        ...
        public function process(Zend_Controller_Request_Abstract $request)
        {
            ...
            if (!$this->hasError()) {
            	...
            	//Zend_Debug::dump($this->image);die;
                $this->image->save();
            }
