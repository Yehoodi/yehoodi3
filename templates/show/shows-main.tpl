...
<div class="grid_8 alpha text showBlock">
    ...
    <div class="grid_5 omega">
        <p>Watch the live coverage of the International Lindy Hop Championships 2015 in Arlington, VA as presented by the Yehoodi crew.</p>
        <p><a class="iconText iconFilmLarge" href="https://www.youtube.com/playlist?list=PLsNUOctiKdE5be-MBGZaILCTuhMGJFy_1">ILHC Live Coverage</a></p>
	</div>
</div>
