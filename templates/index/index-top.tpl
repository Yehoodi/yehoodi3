<div id="div_flashFeaturedCaption">
    <div id="div_flashFeatured">
     	<span id="flashFeatured">
            ...
            <param name="FlashVars" value="xmlfile=/assets20131016/featured-content.xml" />
            <param name="movie" value="/assets20131016/featured-content2.swf" />
            <param name="quality" value="high" />
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="/assets20131016/featured-content2.swf" width="640" height="200">
                <!--<![endif]-->
