...
<table id="featuredTable" class="results resourceSmall">
    <tr class="">
        <td class="thumbnail"><a href="/show/heymisterjesse"><img src="/images/featured-content/HMJ-116-Flash-Feature_thm.png" alt="Hey Mister Jesse" /></a></td>
        <td class="topic">
            <strong><a href="/show/heymisterjesse">Hey Mister Jesse</a></strong><br />
            Precario Swing, Octavi Coronado Swingtet, The After Shavers and more on Hey Mister Jesse #114
        </td>
    </tr>
    <tr class="alt">
        <td class="thumbnail"><a href="/show/thetrack"><img src="/images/featured-content/The-Track-003-Flash-Template.png" alt="The Track" /></a></td>
        <td class="topic">
            <strong><a href="/show/thetrack">The Track with Ryan Swift</a></strong><br />
            Skye Humphries joins Ryan Swift on the next The Track Podcast.
        </td>
    </tr>
    <tr class="">
        <td class="thumbnail"><a href="/show/swingnation"><img src="/images/featured-content/SN-SE04-Flash-Feature_thm.png" alt="SwingNation" /></a></td>
        <td class="topic">
            <strong><a href="/show/swingnation">SwingNation</a></strong><br />
            Interview with Gex Williams and Brian Crone, producers of CtrlAltDance The Movie on this special edition SwingNation.
        </td>
    </tr>
    <tr class="alt">
