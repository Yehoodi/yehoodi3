...
<div class="grid_10 alpha">
    <img id="frankie100Banner" src="/images/graphics/frankie1005.png" alt="Live Broadcast from frankie100 2013, August 23-25" />
    <p id="techSupport">
        <strong><em>Having technical issues?</em></strong>
        Post to our <a href="/comment/174773/yehoodi-frankie100-broadcast-tech-su/">tech support thread</a> or send us an email to <a href="mailto:support@yehoodi.com">support@yehoodi.com</a>.
    </p>
    {if $smart_device}
    ...
    {literal}
        <script>
            new TWTR.Widget({
                ...
                search: '#frankie100',
                interval: 30000,
                /*title: 'frankie100 Tweet Stream',*/
                subject: 'People are tweeting about frankie100',
                width: 254,
                height: 400,
                theme: {
                    shell: {
