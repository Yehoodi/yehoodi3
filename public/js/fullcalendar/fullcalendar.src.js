...
var defaults = {
	...
	buttonText: {
		...
		prevYear: '&nbsp;&lt;&lt;&nbsp;',
		nextYear: '&nbsp;&gt;&gt;&nbsp;',
		today: '<img src="/images/icons/fullcalendar/calendar-blue.png" alt="Today" /> Today',
		month: '<img src="/images/icons/fullcalendar/calendar-select-month.png" alt="Month" /> Month',
		week: '<img src="/images/icons/fullcalendar/calendar-select-week.png" alt="Week" /> Week',
		day: '<img src="/images/icons/fullcalendar/calendar-select.png" alt="Day" /> Day'
	},
...
function _renderDaySegs(segs, rowCnt, view, minLeft, maxLeft, getRow, dayContentLeft, dayContentRight, segmentContainer, bindSegHandlers, modifiedEventId) {
	...
	for (i=0; i<segCnt; i++) {
		...
		html +=
			"<div class='" + className + event.className.join(' ') + "' style='position:absolute;white-space:nowrap;z-index:8;left:"+left+"px'>" +
